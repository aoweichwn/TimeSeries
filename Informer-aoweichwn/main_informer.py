...
# @Time : 2022/4/25 8:41
# @Author : aoweichen
# @File : main_informer.py
# @Software: PyCharm

import argparse
import torch

from InformerCode.exp.exp_informer import Exp_Informer
...
parser.add_argument('--root_path', type=str, default='./InformerCode/data/ETT/', help='root path of the data file')
